...
Config.Keybind = 'F12' -- Keybind to open the weather menu
Config.Command = 'weathermenu' -- Command to open the weather menu
...
Config.AllowedGroups = { -- Allowed groups to use the weather menu
    'admin',
    'god',
    'mod'
}
